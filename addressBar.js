chrome.omnibox.onInputChanged.addListener((text, suggest) => {
  ...
  suggest([
    { content: "stats", description: "Statistics Page Command: stats"},
    { content: "comps", description: "Comps Page Command: comps" },
    { content: "live", description: "Live Command: live"},
    { content: "forum", description: "Forum Command: forum"},
    { content: "regs", description: "Regulations Command: regs"}
    //add person maybe
  ]);
});
